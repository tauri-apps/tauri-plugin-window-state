...
var u$2={};e(u$2,{convertFileSrc:()=>d,invoke:()=>_$1,transformCallback:()=>s$2});function l(){return window.crypto.getRandomValues(new Uint32Array(1))[0]}function s$2(e,r=!1){let n=l(),t=`_${n}`;return Object.defineProperty(window,t,{value:o=>(r&&Reflect.deleteProperty(window,t),e?.(o)),writable:!1,configurable:!0}),n}async function _$1(e,r={}){return new Promise((n,t)=>{let o=s$2(i=>{n(i),Reflect.deleteProperty(window,`_${c}`);},!0),c=s$2(i=>{t(i),Reflect.deleteProperty(window,`_${o}`);},!0);window.__TAURI_IPC__({cmd:e,callback:o,error:c,...r});})}function d(e,r="asset"){return window.__TAURI__.convertFileSrc(e,r)}
...
async function saveWindowState(flags) {
    return _$1("plugin:window-state|save_window_state", { flags });
}
/**
 *  Restore the state for the specified window from disk.
 */
async function restoreState(label, flags) {
    return _$1("plugin:window-state|restore_state", { label, flags });
}
/**
 *  Restore the state for the current window from disk.
 */
async function restoreStateCurrent(flags) {
    return restoreState(E().label, flags);
}
